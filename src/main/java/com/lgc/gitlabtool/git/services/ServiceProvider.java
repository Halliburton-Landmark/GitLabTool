...
public class ServiceProvider {
    ...
    private ServiceProvider() {
        ...
        ClonedGroupsService clonedGroupService = new ClonedGroupsServiceImpl(storageService, loginService);

        _services = new HashMap<>();
        _services.put(LoginService.class.getName(), loginService);
        _services.put(ClonedGroupsService.class.getName(), clonedGroupService);
        _services.put(GroupsUserService.class.getName(),
                new GroupsUserServiceImpl(restConnector, clonedGroupService, storageService));
