package com.lgc.gitlabtool.git.project.nature.operation;
...
public enum Operation {
    ...
    CLONE, PULL, CREATE_BRANCH, CHECKOUT_BRANCH, DELETE_BRANCH, COMMIT, PUSH, GET_PROJECT_STATUS,
    CHANGE_POM_FILE,
    ...
    static {
        GIT_OPERATIONS = EnumSet.of(CLONE, PULL, COMMIT, PUSH,
                CREATE_BRANCH, CHECKOUT_BRANCH, DELETE_BRANCH, GET_PROJECT_STATUS);
