...
/**
 * Implementation of {@link Stash} for storing info about a stash for a single project.
 *
 * It stores info about a project for which was created stash, its message and name.
 *
 * @author Lyudmila Lyska
 */
public class SingleProjectStash implements Stash {
     ...
     */
    public SingleProjectStash (String name, String message, Project project) {
        setName(name);
        setMessage(message);
        setProject(project);
    }
