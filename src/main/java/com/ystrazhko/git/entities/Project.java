...
public class Project {
    ...
    public Project(int id, String description, String default_branch, boolean _public, int visibility_level,
            ...
            int creator_id, Object namespace, Object permissions, boolean archived, String avatar_url,
            boolean shared_runners_enabled, int forks_count, int star_count, String runners_token,
            boolean public_builds, String[] shared_with_groups, boolean only_allow_merge_if_build_succeeds,
            boolean only_allow_merge_if_all_discussions_are_resolved, boolean request_access_enabled) {
        super();
        this.id = id;
